...
#define STRING_CONFIG_H_AUTHOR "(Daniel, Ender-3s)" // Original author or contributor.
 ...
 */
#define SERIAL_PORT 2      // This points to the 5-pin "TFT" header, PA2(TX2), PA3(RX2)
 ...
 */
#define SERIAL_PORT_2 -1   // This points to the USB port
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -12, -2.2 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
